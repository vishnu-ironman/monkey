...
function setup() {
  ...
  ground = createSprite(70,380,600,10);
...
function draw() {
  ...
  }  if(obstacleGroup.isTouching(monkey)&&(life === "one")){
     monkey.scale = 0.12;
    life = "zero";
  } if(obstacleGroup.isTouching(monkey)&&(life ==="zero" )){
       gameState = "end";
    }
...
function obstacles(){
  if (frameCount%100===0) {
    obstacle=createSprite(600,354,20,20);
